...
export default function ClientEdit({ client }: { client: Client }) {
    const { data, setData, put, processing, errors } = useForm({
        name: client.name,
        date_of_birth: client.date_of_birth.substring(0, 10),
        notes: client.notes ?? '',
    });
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-6 p-4">
                ...
                <h1 className="text-2xl font-semibold">{client.name} bewerken</h1>
                ...
                <form onSubmit={handleSubmit} className="max-w-lg space-y-6">
                    ...
                    <div className="flex gap-4">
                        ...
                        <Button variant="outline" asChild>
                            <Link href={`/clients/${client.id}`}>Annuleren</Link>
                        </Button>
                    </div>
                </form>
            </div>
